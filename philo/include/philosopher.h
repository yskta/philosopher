...
/*   Updated: 2023/09/23 14:46:55 by yokitaga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct info{
	...
	pthread_mutex_t		edit_can_continue;//このmutexでlockした時だけ、can_continueを編集する。
	pthread_mutex_t     read_can_continue;//このmutexでlockした時だけ、can_continueを読み込む。
